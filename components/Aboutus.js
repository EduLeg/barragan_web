                        ...
                        <div className='flex-1 relative p-6' data-aos='fade-left' data-aos-offset='300'>
                            <div className="flex flex-col  h-11/12 w-11/12">
                                <div className="flex flex-col mb-4">
                                    ...
                                    <p>Comercializar y distribuir alimentos al mayoreo y menudeo de primera calidad. Con el compromiso de satisfacer las necesidades de nuestros clientes y las de sus familias con el mejor servicio y atención.</p>
                                </div>
                        ...
                        <div className="flex lg:flex-row flex-col lg:gap-x-[20px] gap-y-[10px] flex-wrap items-center justify-between">
                            ...
                            <div className="flex-1 h-[20rem] rounded-lg bg-[#AE1E22] shadow-[#00000084] drop-shadow-2xl flex flex-col p-2 gap-x-[6px] overflow-hidden relative">
                                ...
                                <div className="z-[2]">
                                    ...
                                    <p className="text-white text-[1rem]">El bienestar, unión y la felicidad de nuestros clientes son puntos claves que dan valor al vínculo familiar que formamos como negocio.</p>
                                </div>
