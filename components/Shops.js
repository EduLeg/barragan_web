                    ...
                    <div className='flex flex-col lg:flex-row  lg:gap-x-[10px] relative'>
                        ...
                        <div className='flex-1 flex flex-col gap-y-[10px] p-6' data-aos='fade-right' data-aos-offset='400'>
                            ...
                            <div className="w-full h-[8rem] rounded-lg bg-[#AE1E22] shadow-[#00000084] drop-shadow-2xl flex flex-col p-3 relative  overflow-hidden">
                                ...
                                <p className=' text-white text-[0.5rem]  z-[2] lg:w-[29rem]'>Horario: Lunes a viernes de 6:00 a 4:00. Sábados 6:00 a 3:00 .Domingos 6:00 a 2:00 Teléfono: 3310840256</p>
